...
Future<void> _onSpeechResult(SpeechRecognitionResult result) async {
  ...
  }else if(_lastWords.contains("sonic")||_lastWords.contains("ojith")){
    flutterTts.speak("how can i help ?");
  }else if(_lastWords.contains("meeting") || _lastWords.contains('schedule')){
